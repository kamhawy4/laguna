...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug.en' => [
                ...
                'string',
                'max:255',
                Rule::unique('projects', 'slug->en')->ignore($projectId)
            ],
            'slug.ar' => [
                'nullable',
                'string',
                'max:255',
                Rule::unique('projects', 'slug->ar')->ignore($projectId)
            ],
    ...
    {
        return [
            'name.en.required' => 'The project name in English is required when name is provided.',
            'name.ar.required' => 'The project name in Arabic is required when name is provided.',
